      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <div className="relative bg-white rounded-3xl md:rounded-4xl shadow-xl md:shadow-2xl border border-gray-100/50 overflow-hidden">
              {/* Gradient accent */}
              ...
              <div className="relative px-6 md:px-12 lg:px-16 py-10 md:py-16 lg:py-20">
                <motion.div
                  className="text-center"
                  variants={headerVariants}
                >
                  <motion.p
                    className="text-lg md:text-2xl lg:text-3xl xl:text-4xl text-gray-800 leading-relaxed font-semibold mb-6 md:mb-8"
                    variants={headerVariants}
                  >
                    {t('competitiveAdvantage.cta') as string}
                  </motion.p>
                  ...
                  >
                    <motion.button
                      className="w-full sm:w-auto px-6 py-4 md:px-8 md:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-sm md:text-base lg:text-lg"
                      whileHover={{
                        scale: 1.02,
                        y: -1,
                        boxShadow: "0 15px 35px -8px rgba(59, 130, 246, 0.4)"
                      }}
                      whileTap={{ scale: 0.98 }}
                    >
                      {t('competitiveAdvantage.discussButton') as string}
                    </motion.button>
                    <motion.button
                      className="w-full sm:w-auto px-6 py-4 md:px-8 md:py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-2xl hover:border-gray-400 hover:bg-gray-50 transition-all duration-300 text-sm md:text-base lg:text-lg"
                      whileHover={{
                        scale: 1.02,
                        y: -1,
                        boxShadow: "0 12px 25px -8px rgba(0, 0, 0, 0.1)"
                      }}
                      whileTap={{ scale: 0.98 }}
                    >
                      {t('competitiveAdvantage.learnMoreButton') as string}
                    </motion.button>
                  </motion.div>
                </motion.div>
              </div>

              {/* Mobile-friendly floating accent elements */}
              <motion.div
                className="absolute -top-3 -right-3 md:-top-4 md:-right-4 w-6 h-6 md:w-8 md:h-8 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full opacity-20 blur-sm"
                animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.2, 0.4, 0.2],
                }}
              ...
              />
              <motion.div
                className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 w-8 h-8 md:w-12 md:h-12 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full opacity-10 blur-md"
                animate={{
                  scale: [1, 1.3, 1],
                  opacity: [0.1, 0.3, 0.1],
                }}
