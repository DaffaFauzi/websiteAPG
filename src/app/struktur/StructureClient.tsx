...
const TreeLineVertical = ({ h = 4 }: { h?: number }) => <div className="w-[2px] bg-slate-900 mx-auto" style={{ height: `${h * 4}px` }} />;
          ...
          <GroupCard title={t('org.chart.header')}>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative w-full flex justify-center">
                ...
                {/* DEWAN KOMISARIS */}
                <div className="absolute top-[10px] left-[50%] w-[100px] h-[2px] bg-slate-900" />
              ...
              <div className="relative w-full max-w-[1400px]">
                ...
                <div className="absolute top-0 left-[12.5%] right-[12.5%] h-[2px] bg-slate-900" />
                ...
                <div className="flex justify-between items-start w-full">
                  ...
                  <div className="flex flex-col items-center w-1/4 px-1">
                    ...
                    <div className="relative w-full">
                      <div className="absolute top-0 left-[25%] right-[25%] h-[2px] bg-slate-900" />
                      <div className="flex justify-between items-start w-full">
                          ...
                          <div className="relative w-full">
                            ...
                            <div className="flex justify-between items-start w-full gap-1">
                              <div className="flex flex-col items-center w-1/2">
                                <div className="w-[2px] h-4 bg-slate-900" />
                  ...
                  <div className="flex flex-col items-center w-1/4 px-1">
                    ...
                    <div className="relative w-full">
                      <div className="absolute top-0 left-[30%] right-[15%] h-[2px] bg-slate-900" />
                      <div className="flex justify-between items-start w-full">
                        <div className="flex flex-col items-center w-[65%] px-1">
                          ...
                          <TreeLineVertical h={4} />
                          <div className="relative w-full">
                            <div className="absolute top-0 left-[8.33%] right-[8.33%] h-[2px] bg-slate-900" />
                            <div className="flex justify-between items-start w-full gap-1">
                              {[1, 2, 3, 4, 5, 6].map(num => (
                        ...
                        <div className="flex flex-col items-center w-[35%] px-1">
                          ...
                          <TreeLineVertical h={4} />
                          <div className="relative w-full">
                            <div className="absolute top-0 left-[16.66%] right-[16.66%] h-[2px] bg-slate-900" />
                            <div className="flex justify-between items-start w-full gap-1">
                              {[1, 2, 3].map(num => (
