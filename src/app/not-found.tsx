  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0A66C2] text-white px-6">
      <div className="relative text-center max-w-lg">
        ...
        <Link
          href="/"
          className="apg-btn inline-flex items-center justify-center mt-8 min-h-12 rounded-full bg-white px-6 py-3 text-sm font-extrabold text-slate-950 shadow-[0_0.875rem_2.5rem_rgba(0,0,0,0.18)] hover:bg-white/95 truncate whitespace-nowrap"
        >
          {t('notFound.cta')}
        </Link>
      </div>
